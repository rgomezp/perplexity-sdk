...
import { ChatCompletionResponse  , ChatCompletionResponseObjectEnum      } from '../models/ChatCompletionResponse';
import { ChatCompletionResponseChoicesInner , ChatCompletionResponseChoicesInnerFinishReasonEnum     } from '../models/ChatCompletionResponseChoicesInner';
...
import { ChatCompletionsPostRequest, ChatCompletionsPostRequestModelEnum           } from '../models/ChatCompletionsPostRequest';
...
let enumsMap: Set<string> = new Set<string>([
    "ChatCompletionResponseObjectEnum",
    "ChatCompletionResponseChoicesInnerFinishReasonEnum",
    "ChatCompletionsPostRequestModelEnum",
]);

let typeMap: {[index: string]: any} = {
    "ChatCompletionResponse": ChatCompletionResponse,
    "ChatCompletionResponseChoicesInner": ChatCompletionResponseChoicesInner,
    "ChatCompletionResponseChoicesInnerDelta": ChatCompletionResponseChoicesInnerDelta,
    "ChatCompletionResponseUsage": ChatCompletionResponseUsage,
    "ChatCompletionsPostRequest": ChatCompletionsPostRequest,
    "ChatCompletionsPostRequestMessagesInner": ChatCompletionsPostRequestMessagesInner,
